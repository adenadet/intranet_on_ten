        ...
        try{
            if (empty($data['patient_id'])){
                ...
                [
                    ...
                    'nigerian_address_street' => $data['nigerian_address_street'],
                    'nigerian_address_street2' => $data['nigerian_address_street2'],
                    'nigerian_address_city' => $data['nigerian_address_city'],
                    'nigerian_address_country' => $data['nigerian_address_country'],
                    'uk_address' => $data['uk_address'],
                    'uk_address_street' => $data['uk_address_street'],
                    'uk_address_street2' => $data['uk_address_street2'],
                    'uk_address_city' => $data['uk_address_city'],
                    'uk_address_postcode' => $data['uk_address_postcode'],
