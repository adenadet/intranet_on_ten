...
Route::group(['prefix'=>'emr'], function () {
    Route::get( '/admin/dashboard',              'AdminController@dashboard')->name('administrator.dashboard'); 
    Route::post('/admin/detailed_report',       'AdminController@detailed_report')->name('administrator.detailed_report');
    Route::post('/admin/home_office_report',    'AdminController@home_office_report')->name('administrator.home_office_report');
    Route::post('/admin/radiologist_report',    'AdminController@radiologist_report')->name('administrator.radiologist_report');
    ...
    Route::get( '/appointments/referral/{id}',   'AppointmentController@referral')->name('appointments.referral');
    ...
    Route::get( '/consultations/pending',        'ConsultationController@pending')->name('consultations.pending');
    Route::post('/laboratories/import',			'LaboratoryController@import')->name('laboratories.import');
    Route::get( '/patients/initials',            'PatientController@initials')->name('patients.initials');
    Route::get( '/radiologists/initials',        'RadiologistController@initials')->name('radiologists.initials');
