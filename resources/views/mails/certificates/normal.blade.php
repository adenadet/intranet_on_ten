...
<html>
    ...
    <body>
        ...
        <p>Alternatively, if the PDF is not downloading, kindly <a href="https://intranet.saintnicholashospital.com/certificates/{{$appointment->id}}?p={{$appointment->patient->passport_no}}&f={{$appointment->patient->first_name}}" target="_blank">click here</a> to print it directly</p>
        <p>Thank you</p>
    </body>
</html>