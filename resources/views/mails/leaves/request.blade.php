...
<html>
    ...
    <body>
        ...
        <p>{{$employee->user->first_name}} {{$employee->user->last_name}} ({{$employee->username}}) has requested your approval to proceed on a Leave/Vacation from {{ $leave_request->from_date }} - {{ $leave_request->to_date }}.</p>
