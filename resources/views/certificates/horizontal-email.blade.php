...
<head>
    ...
    <title>{{$patient['last_name']}}, {{$patient['first_name']}} {{$patient['middle_name']}} | St. Nicholas Hospital UK TB Screening Certificate </title>
...
<body>
    <div class="row m-0">
        <div class="col-2 p-3 pt-0">
            <img src="/img/applicants/{{$patient['image']}}" class="img-fluid" />
        </div>
        <div class="col-10">
            <div class="row">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        ...
                        <div class="col-8"><div width="100%"  class="pl-2 rounded" style="border: 1px solid #222; color: #222;"> {{$unique_id}}</div></div>
                    </div>
                    <div class="row">
    ...
    <div class="row m-0">
        ...
        <div class="col-1 mt-3">
            {!! QrCode::size(50)->generate('https://intranet.saintnicholashospital.com/certificates/'.$id) !!}
        </div>
    </div>
</body>
</html>