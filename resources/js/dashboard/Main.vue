        ...
        <div class="container-fluid">            
            <div class="row">
                <section class="col-lg-8 connectedSortable">
                    <div class="row">
                        <div class="col-md-6"><!--ChatQuickView :message_rooms="message_rooms" :contacts="contacts" /--></div>
                        <div class="col-md-6"><UserStaffsLatest :staffs="new_staffs" /></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-5"><NoticeBoard :notices="notices" /></div>
                        <div class="col-md-7"><TicketDetailDashboard :tickets="tickets" /></div>
                    </div>
                </section>
