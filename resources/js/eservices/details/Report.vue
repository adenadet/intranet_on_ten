                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Patient</label>
                            <div class="form-control">{{ FullName(patient) }}</div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <div v-if="report != null" style="width:100%; padding: 2px; border: 1px solid #222; min-height:200px;" v-html="report.details"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <p>Reporting Doctor: <br /><b>{{FullName(consultation.radiologist)}}</b></p>
                <p>Report Date: {{ExcelDate(consultation.radiologist_at) }}</p>
            </div>
        </div>
    </section>
</template>
