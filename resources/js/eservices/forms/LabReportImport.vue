<template>
    <section class="col-md-12">
        <div class="card card-primary">
            ...
            <form role="form" @submit.prevent="uploadLaboratoryReports">
                <div class="card-body">
...
export default {
    ...
    methods: {
        uploadLaboratoryReports(){
            this.loading = true;
            this.leaveReportData.post('/api/emr/laboratories/import')
            .then(response =>{
                this.$emit('refreshPage', response);
                this.loading = false;
                this.$swal.fire({icon: 'success', title: 'The Laboratory Reports have been created', showConfirmButton: false, timer: 1500});
            })
            .catch(()=>{
                this.loading = false;
        ...
        uploadFile(e){
            ...
            if (file['size'] < 2000000){
                reader.onloadend = (e) => {
                    this.leaveReportData.file = reader.result;
