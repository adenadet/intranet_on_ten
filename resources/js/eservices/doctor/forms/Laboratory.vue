        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        <label>Details*</label>
                        <QuillEditor theme="snow" id="details" name="details" placeholder="Details *" required v-model:content="LabReportData.details" content-type="html" :class="{'is-invalid' : LabReportData.errors.has('details') }"></QuillEditor>
                    </div>
                </div>
            </div>
