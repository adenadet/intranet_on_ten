		...
		<div class="col-md-12" style="border: 1px solid #232323;">
			<div class="row">
				...
				<div class="col-md-12 btn-group buttons">
					...
					<button class="btn btn-primary" id="SignBtn" @click.prevent="StartSign()">Use Signature Pad</button>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="buttons">
						...
						<button class="btn btn-primary" @click.prevent="StartSign()">Use Signature Pad</button>
					</div>
				</div>
	...
	methods:{
		...
		createConsentForm(){
            ...
            .then(response =>{
                ...
                this.$swal.fire({icon: 'success', title: 'The Consent Form has been saved', showConfirmButton: false, timer: 1500});
			})
            .catch(()=>{
				this.loading = false;
