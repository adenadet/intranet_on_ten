...
<div class="card row p-3">
    ...
    <table>
        <tr><td>Name:</td><td> {{FullName(patient)}}</td></tr>
    ...
    <div class="col-md-12" style="border: 1px solid #232323;">
        <div class="row">
            ...
            <div class="col-md-3">Date <br /> {{ExcelDate(consent.created_at)}}</div>
            <div class="clear"></div>
            <p class="col-md-12">Please print your name: {{FullName(patient)}}</p>
        </div>
    </div>
    <div class="col-md-12" style="border: 1px solid #232323;">
    ...
    <div class="col-md-12" style="border: 1px solid #232323;">
        ...
        <div class="row">
            ...
            <div class="col-md-3">Date <br /> {{ExcelDate(consent.created_at)}}</div>
            <div class="clear"></div>
            <p class="col-md-12">Please print your name: {{FullName(consent.doctor)}}</p>
        </div>
    </div>
</div>
</section>
