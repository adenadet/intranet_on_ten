...
<section>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <EServiceDocFormLaboratory :patient.sync="patient" :appointment.sync="consultation" @reportReload="closeModals"/>
                </div>
            </div>
        </div>
    </div>
    <div v-if="consultation.laboratory == null" class="card">
        <div class="card-body">
            ...
            <p v-else-if="consultation.consultation.decision == 6 && consultation.report.summary == 'suggestive'">Awaiting report <br /><button class="btn btn-sm btn-primary" @click="addLabReport()">Add Report </button></p>
