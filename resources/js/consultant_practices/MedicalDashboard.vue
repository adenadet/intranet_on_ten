    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-6">
            <div class="small-box bg-dark">
                ...
                <a href="/consultant_pratices/medical/patients" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-6">
            <div class="small-box bg-info">
                ...
                <a href="/consultant_pratices/medical/sessions" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
    <div class="row">
...
export default {
    ...
    methods:{
        ...
        getAllInitials(){
            this.loading = true;
            axios.get('/api/consultant_practices/dashboard?type='+this.type)
            .then(response => {
