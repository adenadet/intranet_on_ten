        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <QuillEditor class="form-control" content-type="html" theme="snow" v-model:content="confirmationData.description" :required="confirmationData.decision === 'reject'"></QuillEditor>
                </div>
            </div>
...
export default {
    ...
    methods: {
        async submit() {
            ...
            this.loading = true;
            this.confirmationData.post('/api/consultant_practices/sessions/confirm_payment')
            .then(response => {
                this.$swal.fire({
                    icon: 'success',
                    title: 'Successful',
